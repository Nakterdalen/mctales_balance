...
public class ModifiedEnchantmentScreenHandler extends ScreenHandler {

    // Mostly copied from EnchantmentScreenHandler
    ...
    public ModifiedEnchantmentScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public ModifiedEnchantmentScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        super(ScreenHandlerType.ENCHANTMENT, syncId);
        this.inventory = new SimpleInventory(2) {
            public void markDirty() {
                super.markDirty();
                ModifiedEnchantmentScreenHandler.this.onContentChanged(this);
            }
        };
        ...
        this.addSlot(new Slot(this.inventory, 1, 35, 47) {
            ...
            public Identifier getBackgroundSprite() {
                return ModifiedEnchantmentScreenHandler.EMPTY_LAPIS_LAZULI_SLOT_TEXTURE;
            }
        });
    ...
    public boolean onButtonClick(PlayerEntity player, int id) {
        if (id >= 0 && id < this.enchantmentPower.length) {
            ...
            String var10000 = player.getStringifiedName();
